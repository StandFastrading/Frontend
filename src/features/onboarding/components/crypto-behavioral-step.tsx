...
const BEHAVIORS: Behavior[] = [
  ...
  { id: "hopium-bags", label: "Holding Hopium Bags", icon: TrendingUp },
  { id: "leverage-gambling", label: "Leverage Gambling", icon: Dices },
];

const TRIGGERS: Behavior[] = [
  { id: "social-hype", label: "Social media hype", icon: MessageCircle },
  { id: "red-days", label: "Red days", icon: ChevronDown },
  { id: "missed-pumps", label: "Missed pumps", icon: AlertTriangle },
  { id: "market-vol", label: "Market volatility", icon: ShieldAlert },
  { id: "influencer-calls", label: "Influencer calls", icon: Newspaper },
  { id: "fomo", label: "Fear of missing out", icon: Eye },
  { id: "winning-streaks", label: "Winning streaks", icon: Trophy },
  { id: "recover-losses", label: "Desire to recover losses", icon: ArrowUp },
];
...
export function CryptoBehavioralStep() {
  ...
  function handleContinue() {
    console.log("[onboarding] crypto.behavioral", {
      behaviors: Array.from(behaviors),
      triggers: Array.from(triggers),
      customBehaviors,
      notes,
    });
    router.push("/onboarding/crypto/risk");
  }
    ...
    <div className="flex flex-1 flex-col gap-5">
        ...
        {creating ? (
          <div className="mt-3 flex gap-2 rounded-lg border border-cyan-400/30 bg-[#08111f]/80 p-2 duration-200 animate-in fade-in slide-in-from-top-1">
            <input
              ...
              placeholder="e.g. Aping into new listings"
      ...
      >
        <textarea
          ...
          placeholder="Example: I oversize after green weeks. I struggle to stay off Twitter during high-vol days..."
          rows={4}
