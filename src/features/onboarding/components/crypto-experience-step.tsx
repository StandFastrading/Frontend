...
const LEVELS = [
  {
    id: "beginner",
    label: "Beginner",
    description: "Learning volatility, structure, and risk management.",
    icon: BookOpen,
  },
  {
    id: "developing",
  ...
  },
  {
    id: "intermediate",
    label: "Intermediate",
    description: "Experienced with structured crypto trading.",
    icon: Target,
  },
  {
    id: "advanced",
    label: "Advanced",
    description: "Actively managing multiple assets and advanced execution.",
    icon: Star,
  },
] as const;
...
export function CryptoExperienceStep() {
  ...
  function handleContinue() {
    console.log("[onboarding] crypto.experience", { level, tenure });
    router.push("/onboarding/crypto/profile");
  }
    ...
    <div className="flex flex-1 flex-col gap-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm leading-relaxed text-slate-300">
          Help StandFast understand how you trade crypto so we can personalize
      ...
      <Section
        icon={GraduationCap}
        title="How experienced are you with crypto trading?"
      ...
      <Section
        icon={User}
        title="How long have you traded crypto?"
      ...
      <Callout
        icon={Lightbulb}
        title="Crypto is 24/7 — discipline is the edge."
        text="The market never closes. Leverage is everywhere. We&apos;ll calibrate intervention strength to where you are."
      />
