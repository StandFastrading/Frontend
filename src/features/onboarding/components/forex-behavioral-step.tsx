...
const BEHAVIORS: Behavior[] = [
  ...
  { id: "impulsive-entries", label: "Impulsive Entries", icon: Zap },
];

const TRIGGERS: Behavior[] = [
  { id: "red-days", label: "Red days", icon: ChevronDown },
  { id: "missed-moves", label: "Missed moves", icon: AlertTriangle },
  { id: "high-vol", label: "High volatility", icon: ShieldAlert },
  { id: "news-spikes", label: "News spikes", icon: Newspaper },
  { id: "winning-streaks", label: "Winning streaks", icon: Trophy },
  { id: "fomo", label: "Fear of missing out", icon: Eye },
  { id: "lack-patience", label: "Lack of patience", icon: Hourglass },
  { id: "social-media", label: "Social media influence", icon: MessageCircle },
];
    ...
    <div className="flex flex-1 flex-col gap-5">
        ...
        {creating ? (
          <div className="mt-3 flex gap-2 rounded-lg border border-cyan-400/30 bg-[#08111f]/80 p-2 duration-200 animate-in fade-in slide-in-from-top-1">
            <input
              ...
              placeholder="e.g. Re-entering on FOMO during London Open"
      ...
      >
        <textarea
          ...
          placeholder="Example: I oversize during London/NY overlap. I struggle to stay flat during NFP..."
          rows={4}
