...
const LEVELS = [
  {
    id: "beginner",
    label: "Beginner",
    description: "Learning pairs, structure, and risk management.",
    icon: BookOpen,
  },
  {
    id: "developing",
    label: "Developing",
    description: "Comfortable with execution but still building consistency.",
    icon: Sparkles,
  },
  {
    id: "intermediate",
    label: "Intermediate",
    description: "Experienced with structured forex trading.",
    icon: Target,
  },
  {
    id: "advanced",
    label: "Advanced",
    description: "Actively managing multiple pairs and advanced execution.",
    icon: Star,
  },
] as const;
...
export function ForexExperienceStep() {
  ...
  function handleContinue() {
    console.log("[onboarding] forex.experience", { level, tenure });
    router.push("/onboarding/forex/profile");
  }
    ...
    <div className="flex flex-1 flex-col gap-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm leading-relaxed text-slate-300">
          Help StandFast understand how you trade forex so we can personalize
      ...
      <Section
        icon={GraduationCap}
        title="How experienced are you with forex trading?"
      ...
      <Section
        icon={User}
        title="How long have you traded forex?"
      ...
      <Callout
        icon={Lightbulb}
        title="Forex is 24/5 — discipline is the moat."
        text="The pairs never sleep. We'll help you set boundaries that protect your edge across every session."
      />
