...
const SPECIAL_RULES: Rule[] = [
  ...
  {
    id: "no-adds-to-losers",
    label: "No adding to losing positions",
    description: "Lock size after the trade goes red.",
    icon: TrendingDown,
  },
  {
    ...
    <div className="flex flex-1 flex-col gap-5">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        <MetricCard
          ...
          subtitle="Concurrent pairs in the book."
        >
          <NumberStepper
        ...
        <MetricCard
          title="Max correlated pair exposure"
          subtitle="Cap pairs that move together (e.g. EUR/USD + GBP/USD)."
        >
          <NumberStepper
        ...
        <MetricCard
          title="Max same-direction positions"
          subtitle="Long-heavy or short-heavy ceiling."
        >
          <NumberStepper
