...
const PRICE_ACTION: Setup[] = [
  ...
  { id: "sr-bounce", label: "Support / Resistance Bounce", description: "Rejection from a major level.", icon: Crosshair },
];
...
const MOMENTUM: Setup[] = [
  ...
  { id: "session-breakout", label: "Session Breakout", description: "Break of session high/low.", icon: SunMedium },
  { id: "vwap-reclaim", label: "VWAP Reclaim", description: "Price reclaims session anchor.", icon: LineChart },
  { id: "range-expansion", label: "Range Expansion", description: "Exit from consolidation.", icon: Activity },
];
...
const MEAN_REVERSION: Setup[] = [
  ...
  { id: "range-fade", label: "Range Fade", description: "Fade the edges of balance.", icon: Repeat },
  { id: "vwap-fade", label: "VWAP Fade", description: "Fade an extension from VWAP.", icon: LineChart },
  { id: "overextended-reversal", label: "Overextended Move Reversal", description: "Climax move flips.", icon: TrendingDown },
];
