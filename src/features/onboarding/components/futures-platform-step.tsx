...
const PLATFORMS: Platform[] = [
  ...
  },
  {
    id: "tradovate",
    label: "Tradovate",
    description: "Cloud-native futures execution.",
    icon: TrendingUp,
  ...
  },
  {
    id: "tradestation",
    label: "TradeStation",
    description: "Multi-asset platform with futures.",
    icon: TrendingUp,
  ...
  },
  {
    id: "quantower",
    label: "Quantower",
    description: "Multi-broker pro trading workstation.",
    icon: Activity,
    logo: "/logos/quantower.svg",
  },
  {
    id: "other-platform",
    label: "Other",
...
const BROKERS: Broker[] = [
  ...
  {
    id: "ninjatrader-broker",
    label: "NinjaTrader Brokerage",
    markets: "Futures",
    icon: Layers,
    logo: "/logos/ninjatrader.svg",
  },
  {
    id: "tradovate-broker",
    label: "Tradovate",
    markets: "Futures (acts as broker)",
    icon: TrendingUp,
    logo: "/logos/tradovate.svg",
  },
  {
    id: "tradestation-broker",
    label: "TradeStation",
...
export function FuturesPlatformStep() {
  ...
  function handleContinue() {
    console.log("[onboarding] futures.platform", {
      platform,
      ...
      <NumberedSection num={1} title="Your primary platform (optional)">
        ...
        {platformIsOther && (
          <OtherNameField
            ...
            placeholder="e.g. MotiveWave, Bookmap, Volfix..."
          />
        )}
      ...
      <NumberedSection num={2} title="Your broker (optional)">
        ...
        {brokerIsOther && (
          <OtherNameField
            ...
            placeholder="e.g. Optimus Futures, Stage 5 Trading..."
          />
        )}
