...
const BEHAVIORS: Behavior[] = [
  ...
  { id: "taking-profits-early", label: "Taking Profits Too Early", icon: ArrowUp },
  { id: "oversizing", label: "Oversizing Contracts", icon: Flame },
  { id: "emotional-reentries", label: "Emotional Re-entries", icon: ArrowDownUp },
  { id: "fomo-chasing", label: "FOMO Chasing", icon: Users },
  { id: "averaging-down", label: "Averaging Down", icon: ArrowDownUp },
  { id: "boredom-trading", label: "Trading Out of Boredom", icon: Coffee },
  { id: "0dte-gambling", label: "0DTE Gambling", icon: Dice5 },
  { id: "ignoring-stops", label: "Ignoring Stop Losses", icon: XCircle },
  { id: "expiration-risk", label: "Holding Through Expiration Risk", icon: CalendarClock },
];
...
const TRIGGERS: Behavior[] = [
  ...
  { id: "market-volatility", label: "Market volatility", icon: ShieldAlert },
  ...
  { id: "recover-losses", label: "Desire to recover losses", icon: Repeat },
];
    ...
    <div className="flex flex-1 flex-col gap-5">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm leading-relaxed text-slate-300">
          Help StandFast recognize the situations that typically affect your
          decision-making. There&apos;s no wrong answer here — just honesty.
        </p>
      </div>
        ...
        {creating ? (
          <div className="mt-3 flex gap-2 rounded-lg border border-cyan-400/30 bg-[#08111f]/80 p-2 duration-200 animate-in fade-in slide-in-from-top-1">
            <input
              ...
              placeholder="e.g. Trading right after a green session"
      ...
      >
        <textarea
          ...
          placeholder="Example: I tend to oversize after a green morning. I also struggle to stay out of 0DTE on FOMC days..."
          rows={4}
