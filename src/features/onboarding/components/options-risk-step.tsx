...
const EXPIRATION_RULES: ExpirationRule[] = [
  {
    id: "no-earnings",
    label: "No holding through earnings",
    description: "Auto-flag positions held into reports.",
    icon: Zap,
  },
  {
    id: "no-overnight",
    label: "No holding overnight",
    description: "Close before the bell. Sleep without P&L.",
    icon: MoonStar,
  },
  {
    id: "no-revenge",
  ...
  {
    id: "no-0dte-after-losses",
    label: "No 0DTE after losses",
    description: "Pause same-day expirations on red sessions.",
    icon: CalendarX,
  },
  {
    id: "auto-cooldown",
...
const DEFAULT_RULES = new Set(["no-earnings", "no-revenge", "auto-cooldown"]);
    ...
    <div className="flex flex-1 flex-col gap-5">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        <MetricCard
          ...
          subtitle="When to stop. No more decisions for the day."
        >
          <NumberStepper
            value={dailyLoss}
        ...
        <MetricCard
          title="Max contracts allowed"
          subtitle="Hard cap per position."
        >
          <NumberStepper
            value={maxContracts}
      ...
      <Callout
        icon={Sparkles}
        title="Your framework is designed to protect you from emotional decisions."
        text="These rules don't restrict you — they free you. Discipline at the boundary is what compounds over time."
      />
